...
<body>
        ...
        <div class="container pt-4 mt-5">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 mx-auto">
                    ...
                    <div class="mb-3">
                        <h1 class="fs-2 mb-2">Learn up to 300 phrasal verbs</h1>
                    ...
                    <div id="phrasal-verbs" class="mt-4 row align-content-start">
    ...
    <a href="#down" class=" scroll-top scroll-down btn-hover">
        <img src="./src/media/arrow.png" alt="arrow to scroll down" class="upsidedown" width="14">
    </a>
    ...
    <script>
        ...
        let url = "phrasal-verbs";
    </script>
    <script src="./src/js/phrasal-verbs.js?v=8"></script>
