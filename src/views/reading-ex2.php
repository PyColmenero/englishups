...
<head>
    ...
    <title>English Ups - Learn tips Exercise 2 Reading </title>
...
<body>
                ...
                <div class="col-12 col-md-10 col-lg-9 mx-auto">
                    <div class="d-block d-md-flex justify-content-between mt-5">
                        <div class="mb-3 mb-md-0 pt-4">
                            <h1 class="fs-3">Reading Ex2 - Most common words</h1>
                        </div>
    ...
    <script src="./src/js/reading-ex2.js?v=1"></script>
