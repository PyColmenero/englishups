...
<head>
    ...
    <meta name="description" content="Learn Different ways to say words for a better vocabulary.">

    <title>English Ups - Learn Different ways to say...</title>
...
<body>
            ...
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 mx-auto text-dark">
                    <div class="mb-3 d-block d-md-flex">
                        <h1>Different ways to say...</h1>
                        <!-- <input type="text" class="form-control ms-auto mt-3 mt-md-0" placeholder="Search..." id="search"> -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-4">
            ...
            <div class="row mx-auto" id="content">
                ...
                <div class="col-12 col-md-10 col-lg-8 mx-auto text-dark">
                    ...
                    <div class="row" id="differents_div">
    ...
    <script>
        let url="different-ways-to-say";
    </script>

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"> </script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>

    <script src="./src/js/different.js?v=2"></script>
